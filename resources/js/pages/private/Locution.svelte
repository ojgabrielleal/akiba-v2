...
{#if onair.data.type === "live" && onair.data.program.host.uuid !== user.uuid}
    ...
    >
        <div class="w-sm p-6 rounded-xl bg-suspense-aurora">
            ...
            <div
                class="mt-6 mb-4 bg-red-crimson p-3 rounded-xl text-center text-suspense-aurora font-noto-sans font-bold uppercase"
            >
...
{#if onair.data.type === "scheduled"}
    ...
    >
        <div class="w-sm p-6 rounded-xl bg-suspense-aurora">
            ...
            <div
                class="mt-6 mb-4 bg-neutral-gray p-3 rounded-xl text-center text-suspense-aurora font-noto-sans font-bold uppercase"
            >
