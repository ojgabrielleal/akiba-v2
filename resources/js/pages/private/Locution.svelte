...
{#if onair.data.type === "live" && onair.data.program.host.uuid !== user.uuid}
    <section
        ...
        class="fixed inset-0 flex items-center justify-center p-2 lg:p-0 z-50 bg-black/20 backdrop-blur-lg"
    >
        <div class="w-sm p-6 rounded-xl bg-neutral-aurora">
            ...
            <div
                class="mt-6 mb-4 bg-red-crimson p-3 rounded-xl text-center text-neutral-aurora font-noto-sans font-bold uppercase"
            >
                PARE! Tem gente ao vivo!
            </div>
            <div class="font-noto-sans mb-3">
                Opa! quer tirar {onair.data.program.host.gender === "male"
                    ? "o"
                    : "a"}
...
{#if onair.data.type === "scheduled"}
    ...
    >
        <div class="w-sm p-6 rounded-xl bg-neutral-aurora">
            ...
            <div
                class="mt-6 mb-4 bg-neutral-gray p-3 rounded-xl text-center text-neutral-aurora font-noto-sans font-bold uppercase"
            >
                Programa agendado no ar!
            </div>
            <div class="font-noto-sans mb-3">
                Opa! Um programa agendado por um dos admininistradores já está
                no ar! Não tem como adiantar, pular ou cancelar na marra aqui
                ninguém sabe como mudar o tempo! Respeite o horário e espere ele
                terminar para poder entrar ao vivo!
            </div>
            <button
                on:click={() => redirectToDashboard()}
                type="button"
