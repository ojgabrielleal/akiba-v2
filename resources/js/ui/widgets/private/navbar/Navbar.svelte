...
<!-- Sidebar Menu -->
<div class={["fixed top-0 left-0 h-full w-64 bg-neutral-aurora z-50 shadow-md transform transition-transform duration-300", { "translate-x-0": mobilenavbar }, { "-translate-x-full": !mobilenavbar }]}>
