...
<nav
    class="w-full h-[3rem] bg-neutral-aurora hidden items-center justify-center lg:flex"
>
                ...
                {#if hasPermission(item.permission)}
                    <li>
                        <a
                            ...
                            class="flex items-center gap-2 text-neutral-aurora"
                        >
                            <img
                                src={item.icon}
                                alt=""
...
<!-- Mobile Navbar -->
<nav
    class="w-full h-[4rem] bg-neutral-aurora flex items-center justify-between px-10 lg:hidden"
>
    <button
...
<div
    class={[
        "fixed top-0 left-0 h-full w-64 bg-neutral-aurora z-50 shadow-md transform transition-transform duration-300",
