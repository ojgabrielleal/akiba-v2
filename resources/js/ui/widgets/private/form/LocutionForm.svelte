...
<Section title="Meus Programas">
    <form on:submit|preventDefault={submit}>
                ...
                {#each programs.data as item}
                    ...
                    >
                        <img
                            ...
                            loading="lazy"
                            class={[
                                "w-60 transition duration-300 ease-in-out",
                                {
                                    "opacity-50 scale-90":
                                        $form.program === item.uuid,
                                },
        ...
        <div class="mb-15">
            ...
            <div
                class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-9 gap-30 lg:gap-y-30 lg:gap-x-5 mt-28"
            >
                {#each locutionIcons as item, index}
                    <button
                        ...
                        class={[
                            "cursor-pointer w-[9.55rem] h-12 flex justify-end items-end rounded-lg bg-suspense-aurora transition duration-300 ease-in-out",
