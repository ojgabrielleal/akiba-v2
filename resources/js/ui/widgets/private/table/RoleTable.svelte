    ...
    {#if roles && roles.data.length > 0}
        <div class="overflow-x-auto w-full">
            <table class="min-w-[900px] w-full border-collapse table-auto">
                <thead>
                    <tr
                        class="text-neutral-aurora uppercase text-sm font-bold italic whitespace-nowrap"
                    >
                        <th class="p-4 text-start min-w-[180px]">Cargo</th>
                        <th class="p-4 text-start min-w-[180px]"
                            >Membros relacionados</th
                        >
                ...
                <tbody>
                    {#each roles.data as item}
                        <tr
                            class="border-t border-neutral-aurora/20 text-neutral-aurora whitespace-nowrap"
                        >
