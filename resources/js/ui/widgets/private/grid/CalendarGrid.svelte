...
<Section {title}>
    ...
    <div class="w-full overflow-x-auto pb-4">
        ...
        <div
            class="w-full min-w-[1280px] grid gap-2 mt-5 grid-cols-7 overflow-auto"
        >
            {#each week as day}
                <div class="flex flex-col gap-2 w-full">
                    <div
                        class="text-suspense-aurora text-lg font-noto-sans text-center font-bold uppercase italic"
                    >
                        {day.day}
                    </div>
