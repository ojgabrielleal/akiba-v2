...
{#if posts}
    <Section {title}>
        <div
            class="gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5"
        >
            {#each posts.data as item}
                ...
                <article
                    class={[
                        "w-full h-56 rounded-lg p-4 relative",
                ...
                >
                    ...
                    <div
                        class={[
                            "grid absolute bottom-2 left-4 w-[calc(100%-2rem)]",
                            {
                                "grid-cols-3":
                                    item.type === "published" ||
                                    item.type === "revision",
