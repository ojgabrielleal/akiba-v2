        ...
        <div class="gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {#each posts.data as item}
                ...
                <article class="w-full h-60 bg-blue-ocean rounded-lg overflow-hidden relative">
                    ...
                    <div class={["grid grid-cols-[0.4fr_1fr_0.6fr] items-center absolute bottom-0 w-full py-2 px-4",
                        ...
                        <div class="mt-[0.3rem] w-full font-noto-sans font-bold italic uppercase text-md text-suspense-aurora text-center truncate">
