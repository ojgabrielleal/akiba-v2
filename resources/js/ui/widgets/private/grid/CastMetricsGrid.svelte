        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex shrink-0 items-center gap-3">
                ...
                <div class="group relative flex h-10 w-10 items-center justify-center">
                    ...
                    <div class="pointer-events-none absolute bottom-full left-1/2 z-10 flex h-[153px] w-10 -translate-x-1/2 items-start justify-center opacity-0 transition group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100">
