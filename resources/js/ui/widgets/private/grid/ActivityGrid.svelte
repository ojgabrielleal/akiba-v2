        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
            {#if activities.data.length > 0}
                {#each activities.data as item}
                    <article class="h-55 w-full shrink-0 rounded-lg p-4 relative bg-blue-skywave">
                        ...
                        {#if can.update}
                            <button
                                ...
                                class="w-8 h-8 bg-neutral-aurora rounded-lg absolute bottom-3 right-4 flex justify-center items-center font-noto-sans italic font-bold cursor-pointer"
                                onclick={() => {
