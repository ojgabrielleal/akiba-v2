...
{#if success}
    <div class="h-100 py-3">
        ...
        <div class="text-sm font-noto-sans text-gray-500">
            Seu pedido já tá a caminho! {air.program.host.gender === "male" ? "O DJ" : "A DJ"} {air.program.host.nickname} 
...
{:else}
    <div class="h-100 py-3">
        ...
        <div class="text-sm font-noto-sans text-gray-500">
            O programa não tá rolando ou {air.program.host.gender === "male" ? "o DJ" : "a DJ"} {air.program.host.nickname} tá 
